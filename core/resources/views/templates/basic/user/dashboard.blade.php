        ...
        <div class="row g-3 g-md-4 justify-content-center">
            ...
            <div class="col-md-6 col-sm-6 col-xsm-6">
                <div class="dashboard-widget">
                    ...
                    <h4 class="dashboard-widget__number">{{ showAmount($user->balance, currencyFormat: false) }}</h4>
            ...
            <div class="col-md-6 col-sm-6 col-xsm-6">
                <div class="dashboard-widget">
                    ...
                    <h4 class="dashboard-widget__number">{{ showAmount($widget['total_income'], currencyFormat: false) }}
                    </h4>
            ...
            <div class="col-md-6 col-sm-6 col-xsm-6">
                <div class="dashboard-widget">
                    ...
                    <h4 class="dashboard-widget__number">
                        {{ showAmount($widget['total_withdrawan'], currencyFormat: false) }}</h4>
