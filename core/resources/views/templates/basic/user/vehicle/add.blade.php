...
@section('content')
    <div class="card custom--card">
        <div class="card-body">
            <form action="{{ route('user.vehicle.update', @$vehicle->id) }}" method="post"
                ...
                <div class="row gy-1 mb-3">
                            ...
                            <select name="vehicle_type_id" class="form--control vehicle-type" required>
                                ...
                                @foreach ($vehicleTypes as $vehicleType)
                                    <option value="{{ $vehicleType->id }}"
                                            @selected(old('vehicle_type_id', @$vehicle->vehicle_type_id) == @$vehicleType->id) data-vehicle_classes="{{ $vehicleType->vehicleClass }}"
                                            data-manage_class="{{ $vehicleType->manage_class }}">{{ __($vehicleType->name) }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control form--control" name="cc" required
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" step="any" class="form-control form--control" name="bhp" required
                                       value="{{ old('bhp', @$vehicle->bhp) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control form--control" name="speed" required
                                       value="{{ old('speed', @$vehicle->speed) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form--control" name="cylinder" required
                                   value="{{ old('cylinder', @$vehicle->cylinder) }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form--control" name="identification_number" required
                                   value="{{ old('identification_number', @$vehicle->identification_number) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control form--control" name="mileage" required
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="fuel_type" class="form--control select2-basic" required>
                                <option value="" selected disabled>@lang('Select One')</option>
                                <option
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" step="any" class="form-control form--control" name="total_run"
                                       required
                                       value="{{ old('total_run', @$vehicle->total_run ? getAmount(@$vehicle->total_run) : '') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" step="any" class="form-control form--control" name="price" required
                                       value="{{ old('price', @$vehicle->price ? getAmount(@$vehicle->price) : '') }}">
                                <span
                                    class="input-group-text bg--base text-white border-0">{{ __(gs('cur_text')) }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description"
                                  class="form-control nicEdit">@php echo @$vehicle->description @endphp</textarea>
                    </div>
