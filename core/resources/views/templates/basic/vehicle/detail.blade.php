                            ...
                            <div class="details-info">
                                ...
                                <div class="details-info__right">
                                    <div class="details-info-content">
                                        ...
                                        <h5 class="details-info-content__price">{{ showAmount($vehicle->price) }} {{ __(gs('cur_text')) }}/ @lang('Day')</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <div class="">
                        ...
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <h6>@lang('Total') : <span class="total-price">{{ getAmount($vehicle->price) }}</span> {{ __(gs('cur_text')) }}</h6>
                        </div>
                    </div>
